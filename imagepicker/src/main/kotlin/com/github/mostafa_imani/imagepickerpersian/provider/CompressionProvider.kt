package com.github.mostafa_imani.imagepickerpersian.provider
...
import com.github.mostafa_imani.imagepickerpersian.ImagePickerActivity
import com.github.mostafa_imani.imagepickerpersian.util.ExifDataCopier
import com.github.mostafa_imani.imagepickerpersian.util.FileUtil
import com.github.mostafa_imani.imagepickerpersian.util.ImageUtil
import java.io.File
        ...
        object : AsyncTask<Uri, Void, File>() {
            ...
            override fun onPostExecute(file: File?) {
                ...
                if (file != null) {
                    ...
                    // Post Error
                    setError(com.github.mostafa_imani.imagepickerpersian.R.string.error_failed_to_compress_image)
                }
            }
        }.execute(uri)
    }
