package com.github.dhaval2404.imagepickerpersian.provider
...
import com.github.dhaval2404.imagepickerpersian.ImagePickerActivity
import com.github.dhaval2404.imagepickerpersian.util.ExifDataCopier
import com.github.dhaval2404.imagepickerpersian.util.FileUtil
import com.github.dhaval2404.imagepickerpersian.util.ImageUtil
import java.io.File
        ...
        object : AsyncTask<Uri, Void, File>() {
            ...
            override fun onPostExecute(file: File?) {
                ...
                if (file != null) {
                    ...
                    // Post Error
                    setError(com.github.dhaval2404.imagepickerpersian.R.string.error_failed_to_compress_image)
                }
            }
        }.execute(uri)
    }
